...
% % The plot for this
% 
% load('shading_validation.mat')
% 
% gcr = results.gcr;
% shadingratio = results.Var10;
% shading_reduction_factor = (1 - shadingratio) * 100;  % Shading Reduction Factor as a percentage
% 
% % Create a plot of Shading Reduction Factor against GCR
% figure; % Opens a new figure window
% plot(gcr, shading_reduction_factor, 'o-', 'LineWidth', 2);  % Plots the points with line connecting them and a thicker line
% xlabel('Ground Coverage Ratio (GCR)', 'FontSize', 24);  % Label for the x-axis with larger font
% ylabel('Shading Reduction Factor (%)', 'FontSize', 24);  % Label for the y-axis with larger font and percentage
% title('Shading Reduction Factor vs GCR', 'FontSize', 24);  % Title for the plot with larger font
% set(gca, 'FontSize', 24); % Sets the font size for the axes
